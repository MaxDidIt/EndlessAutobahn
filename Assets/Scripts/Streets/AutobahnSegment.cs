...
public class AutobahnSegment : MonoBehaviour
{
    ...
    private void GenerateMesh()
    {
        ...
        do
        {
            ...
            if (finishedRows > MESH_SUBDIVISIONS)
            {
                subGameObject = new GameObject();
                subGameObject.name = "Subsegment";
                subGameObject.transform.SetParent(this.transform, false);

                meshRenderer = subGameObject.AddComponent<MeshRenderer>();
                meshRenderer.sharedMaterial = Resources.Load<Material>("Pavement");
                meshRenderer.sharedMaterial.mainTextureScale = new Vector2(1, 12);
                ...
                rows = meshPositions.Count / MESH_SUBDIVISIONS;
                ...
                meshFilter = subGameObject.AddComponent<MeshFilter>();
